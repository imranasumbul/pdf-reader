    ...
    >
      ...
      {showZenModeInfo && (
        <div className="absolute inset-0 flex items-center justify-center z-50 pointer-events-none">
          <div className="bg-black/80 text-white px-6 py-4 rounded-lg shadow-lg max-w-md text-center backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs mt-3 bg-black/30 p-2 rounded">
      ...
      >
        <button
          ...
          className="bg-black/30 hover:bg-black/50 p-2 rounded-full transition-colors text-white"
      ...
      >
        <p className="text-center p-4 text-muted-foreground">
          ...
          <a href={fileUrl} download className="text-primary underline">
            download the PDF
          </a>{" "}
          to view it.
        </p>
